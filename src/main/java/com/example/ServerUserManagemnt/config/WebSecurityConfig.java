package com.example.ServerUserManagemnt.config;

import com.example.ServerUserManagemnt.jwt.JwtAuthorizationFilter;
import com.example.ServerUserManagemnt.jwt.JwtTokenProvider;
import com.example.ServerUserManagemnt.service.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.addFilter((Filter) new JwtAuthorizationFilter(authenticationManager(), tokenProvider));
    }
